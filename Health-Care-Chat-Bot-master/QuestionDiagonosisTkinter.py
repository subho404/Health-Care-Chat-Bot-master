...
training_dataset = pd.read_csv(r'D:\Health-Care-Chat-Bot-master\Health-Care-Chat-Bot-master\Training.csv')
test_dataset = pd.read_csv(r'D:\Health-Care-Chat-Bot-master\Health-Care-Chat-Bot-master\Testing.csv')
...
doc_dataset = pd.read_csv(r'D:\Health-Care-Chat-Bot-master\Health-Care-Chat-Bot-master\doctors_dataset.csv', names = ['Name', 'Description'])
...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Soumojit Banerjee", bg="yellow2", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="Subham Biswas", bg="yellow1", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
