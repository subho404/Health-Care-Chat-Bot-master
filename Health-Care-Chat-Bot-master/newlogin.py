...
# Destroy existing packed widgets in the parent window
...
def register():
    ...
    register_screen = Toplevel(root)  # Create a new Toplevel window
...
def login():
    global login_screen
    login_screen = Toplevel(root)  # Create a new Toplevel window using 'root' as the parent
